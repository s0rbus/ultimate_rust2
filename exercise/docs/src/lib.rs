...
/*!
 * A pumpkin is a cultivated winter squash in the genus Cucurbita. The term is most commonly applied to round,
 * orange-colored squash varieties, though it does not possess a scientific definition and may be used in reference to many
 * different squashes of varied appearance.
 *
 * ![an image of a pile of pumpkins](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/FrenchMarketPumpkinsB.jpg/700px-FrenchMarketPumpkinsB.jpg)
 */
...
impl Pumpkin {
    /// Calling smash will remove the pumpkin
    pub fn smash(self) {}
}
...
/// Is used with the `orangeness` field in [`Pumpkin`]
